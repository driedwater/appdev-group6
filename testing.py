...
i = Image.open('proxy-image.jpg')

resized = resize_image(i, 125)
resized.save('C:\Users\\aa\Desktop\School homework\App Development Project\\assignment\ecommercesite')